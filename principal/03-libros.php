...
<div class="card">
    <img src="./imagenes/03-libros.jfif" alt="El principito" style="width:100%">
  <h1>El principito</h1>
  <p class="price">$47.20</p>
  <p>El principito es una fábula infantil que disfrutan por igual los niños y los adultos.</p>
  <p><select id="qty">
