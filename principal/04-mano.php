...
<div class="card">
    <img src="./imagenes/04-mano.jpg" alt="Llavero mariachi" style="width:100%">
  <h1>Llavero mariachi</h1>
  <p class="price">$189.00</p>
  <p>“Sones del corazón” El mariachi es el género musical más famoso de México y es el resultado del 
      mestizaje cultural: una fusión sonora de las guitarras y violines con las caracolas, trompetas, 
      flautas y otros instrumentos indígenas lo que ocasionó que fuera algo único y nuevo. Utilizan traje 
      de charro como uniforme convirtiéndose así en un ícono de orgullo mexicano. LLAVERO DE PVC EN FORMA 
      DE MARIACHI</p>
<p><select id="qty">
