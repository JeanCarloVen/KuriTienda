...
<div class="card">
    <img src="./imagenes/01-libros.jpg" alt="Learn to write" style="width:100%">
  <h1>Learn to write</h1>
  <p class="price">$145.84</p>
  <p>Set kids up to succeed in school with a learn to write for kids guide that teaches them letters, 
      shapes, and numbers-and makes it fun. My First Learn-to-Write Workbook introduces your early 
      writer to proper pen control, steady line tracing, new words, and more with dozens of exercises 
      that will engage their minds and boost their reading and writing comprehension skills.</p>
  <p><select id="qty">
