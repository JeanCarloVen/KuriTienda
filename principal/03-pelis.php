...
<div class="card">
    <img src="./imagenes/03-pelis.jpg" alt="And Now for Something Completely Different" style="width:100%">
  <h1>And Now for Something Completely Different</h1>
  <p class="price">$372.33</p>
  <p>A collection of re-filmed sketches from the first and second series of the cult TV comedy show, "Monty 
      Python's Flying Circus". Includes such classics as "Nudge, Nudge", "Hell's Grannies", "Killer Cars", 
      "Dead Parrot", "Lumberjack Song", "Blackmail" and "Upper Class Twit of the Year".</p>
  <p><select id="qty">
