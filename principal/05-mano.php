...
<div class="card">
    <img src="./imagenes/05-mano.jpg" alt="Delantal mandil estampado VW Van Combi" style="width:100%">
  <h1>Delantal mandil estampado VW Van Combi</h1>
  <p class="price">$320.00</p>
  <p>Delantal mandil para carnes asadas estampado de una VW Van Combi vintage retro. Las medidas del delantal 
      son 75x60 cms. . El bies y los listones son de color negro.</p>
<p><select id="qty">
